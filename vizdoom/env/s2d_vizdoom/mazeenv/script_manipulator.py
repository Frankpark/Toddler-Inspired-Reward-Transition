...
def write_acs(random_player_spawn, random_key_positions, map_size, key_categories,
              random_key_textures, default_spawn_pos, default_key_pos, acs_path,
              random_wall_texture, random_floor_texture, random_ceiling_texture,
              wall_texture_list, floor_texture_list, ceiling_texture_list,
              keys_used_list, use_key_boxes, shuffle_obj_pos,
              boxes_dims, random_player_spawn_angle, min_spawn_dist_from_player,
    ...
    wall_textures = '{"' + '","'.join(wall_texture_list) + '"}'
    floor_textures = '{"' + '","'.join(floor_texture_list) + '"}'
    ceiling_textures = '{"' + '","'.join(ceiling_texture_list) + '"}'
    num_wall_textures = len(wall_texture_list)
    num_floor_textures = len(floor_texture_list)
    num_ceiling_textures = len(ceiling_texture_list)
    ...
    d = {
        'num_keys': num_keys, 'random_spawn': random_player_spawn,
        'xmin': xmin, 'ymin': ymin, 'xmax': xmax, 'ymax': ymax,
        'random_wall_texture': random_wall_texture, 'random_floor_texture': random_floor_texture,
        'random_ceiling_texture': random_ceiling_texture, 'wall_texture_list': wall_textures,
        'floor_texture_list': floor_textures, 'ceiling_texture_list': ceiling_textures,
        'num_wall_textures': num_wall_textures, 'num_floor_textures': num_floor_textures,
        'num_ceiling_textures': num_ceiling_textures,
